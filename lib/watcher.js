...
const baseDirFromPattern = function (pattern) {
  return pattern
...
const watchPatterns = function (patterns, watcher) {
...
const createIgnore = function (patterns, excludes) {
...
const onlyWatchedTrue = function (pattern) {
  return pattern.watched
}

const getWatchedPatterns = function (patternObjects) {
