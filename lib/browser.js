...
import {bindAll, EventEmitter} from './events'
...
interface Timer {
  setTimeout(work: () => void, delay: number): Timer,
  clearTimeout(): void
}
...
function Browser (
  id: string,
  fullName: string,
  /* capturedBrowsers */ collection: any,
  emitter: EventEmitter,
  socket: any,
  timer: Timer,
  /* config.browserDisconnectTimeout */ disconnectDelay: number,
  /* config.browserNoActivityTimeout */ noActivityTimeout: number
  ) {
  ...
  var disconnect = function (reason: string = '') {
